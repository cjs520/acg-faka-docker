<?php
/* Smarty version 3.1.46, created on 2024-05-31 08:47:53
  from '/var/www/html/app/View/Admin/Trade/Commodity.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.46',
  'unifunc' => 'content_66598eb92bb070_71796065',
...
function content_66598eb92bb070_71796065 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        layui.use(['hex'], function () {
            ...
            table.bootstrapTable({
                ...
                detailFormatter: function (index, item, element) {
                    return $('.commodity-modal').html()
                        ...
                        .replace('[inventory_sync]', action.inventorySync(item))
            ...
            let modalAction = {
                showShared(unqueId) {
                    ...
                    cao.popupElement("inventory_sync", "input", unqueId).parent().show();
                ...
                hideShared(unqueId) {
                    ...
                    cao.popupElement("inventory_sync", "input", unqueId).parent().hide();
            ...
            let modal = (values = {}) => {
                cao.popup('/admin/api/commodity/save', [
                    ...
                    },
                    {
                        ...
                        type: "switch",
                        text: "开启",
                        tips: "开启后，自动同步共享平台的数量，请把控数量可能会导致网站变卡顿"
                    },
                    {
                        title: "发货方式",
                        name: "delivery_way",
